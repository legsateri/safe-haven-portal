                ...
                <div class="col-3">
                    <div id="list-example" class="list-group">
                        ...
                        <a href="#list-item-1" class="list-group-item list-group-item-action flex-column align-items-start active">
                            ...
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                <small>Chicago</small>
                                <button id="list-button-item-1" type="button" class="btn-sm btn-primary">Release Client</button>
                            </div>
                        </a>
                        {{--<a class="list-group-item list-group-item-action" href="#list-item-2">Item2</a>--}}
                        <a href="#list-item-2" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Client C2</h5>
                                <small>07/12/2017</small>
                            </div>
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                <p class="mb-1">90025</p>
                            ...
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                ...
                                <button id="list-button-item-2" type="button" class="btn-sm btn-primary">Release Client</button>
                            </div>
                        </a>
                        ...
                        <a href="#list-item-3" class="list-group-item list-group-item-action flex-column align-items-start">
                            ...
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                <small>Chicago</small>
                                <button id="list-button-item-3" type="button" class="btn-sm btn-primary">Release Client</button>
                            </div>
                        </a>
                        {{--<a class="list-group-item list-group-item-action" href="#list-item-4">Item 4</a>--}}
                        <a href="#list-item-4" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Client C4</h5>
                                <small>07/12/2017</small>
                            </div>
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                <p class="mb-1">90025</p>
                            ...
                            <div class="justify-content-between d-flex zip_pet_number_cont mt-3">
                                <small>Chicago</small>
                                <button id="list-button-item-4" type="button" class="btn-sm btn-primary">Release Client</button>
                            </div>
                        </a>
                        {{--<a href="#list-item-4" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
